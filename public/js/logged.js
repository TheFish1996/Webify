...
const checker = phrase => {
  //checks if a comment was even provided or not
...
(function($) {
  ...
  $("#UsTop50Category").click(function(event) {
    //upon click of category it hides all other content and only displays USTop50 data
  ...
  $("#GlobalTop50Category").click(function(event) {
    //upon click of category it hides all other content and only displays GlobalTop50 data
  ...
  $("#GlobalViral50Category").click(function(event) {
    //upon click of category it hides all other content and only displays GlobalViral50 data
    $(".GlobaTop50SongFeed").attr("style", "display: none");
  ...
  $("#UsViral50Category").click(function(event) {
    //upon click of category it hides all other content and only displays USViral50 data
    $(".GlobaTop50SongFeed").attr("style", "display: none");
    $(".GlobaViral50SongFeed").attr("style", "display: none");
  ...
  $("#RegularCategory").click(function(event) {
    //upon click of category it hides all other content and only displays Whole song feed data
    $(".GlobaTop50SongFeed").attr("style", "display: none");
    $(".GlobaViral50SongFeed").attr("style", "display: none");
    $(".USViral50SongFeed").attr("style", "display: none");
